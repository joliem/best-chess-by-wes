              ...
              >
                ...
                {crowned && (
                  <span
                    ...
                    className="pointer-events-none absolute inset-[8%] z-10 rounded-full border-[3px] border-torch shadow-[0_0_0.7em_oklch(0.78_0.16_70/0.9),inset_0_0_0.45em_oklch(0.78_0.16_70/0.5)]"
                  />
                )}
                {shielded && !crowned && (
                  <span
                    title="Invincible — cannot be captured"
                    className="pointer-events-none absolute inset-[8%] z-10 rounded-full border-[3px] border-slate-200 shadow-[0_0_0.7em_oklch(0.88_0.02_240/0.95),inset_0_0_0.45em_oklch(0.88_0.02_240/0.55)]"
                  />
                )}
